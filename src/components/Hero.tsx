...
import heroImg from "../assets/images/korean_leak_technician_1782448740587.jpg";
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full lg:w-[48%] h-[350px] lg:h-full lg:absolute lg:right-0 lg:top-0 lg:bottom-0 overflow-hidden bg-slate-100 z-0 select-none">
        ...
        <div
          className="hidden lg:block absolute inset-0 bg-cover bg-center transition-all duration-700"
          style={{
        ...
        <div className="absolute bottom-12 left-1/2 lg:left-[58%] -translate-x-1/2 z-20 flex items-center gap-2">
          ...
          <span className="w-2.5 h-2.5 rounded-full border border-white bg-transparent" />
        </div>
